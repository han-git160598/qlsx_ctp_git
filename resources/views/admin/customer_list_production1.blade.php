...
<div id="sidebar-left">
    <ul id="main-menu">
        ...
        <li class="item"><a href="{{url('/admin/customer_list_customer')}}">Khách hàng</a></li>
        <li class="item"><a href="{{url('/admin/customer_list_order')}}">Đơn hàng</a></li>
        <li class="item"><a href="{{url('/admin/customer_list_product_inventory')}}">Kho hàng</a></li>
        <li class="item"><a href="{{url('/admin/customer_list_inventory')}}">Kiểm kê kho</a></li>

        <li class="item active"><a href="{{url('/admin/customer_list_production')}}">Sản xuất</a></li>
        <li class="item"><a href="{{url('/admin/customer_list_vendor')}}">Nhà cung ứng</a></li>
        <li class="item"><a href="{{url('/admin/customer_list_product')}}">Sản phẩm</a></li>
        <li class="item"><a href="{{url('/admin/customer_list_ship')}}">Vận chuyển</a></li>
        <li class="item"><a href="{{url('/admin/customer_list_account')}}">Tài khoản</a></li>
        <li class="item"><a href="{{url('/admin/customer_setting')}}">Cài đặt</a></li>
    </ul>
</div>
@endsection
                            ...
                            <table class="table table-bordered">
                                <thead style="background-color: #FFF6E5;">
                                    <tr>
                                        ...
                                        <th>Thứ 2
                                            <p class="t-label pt-1 fz-075rem fw-400">2017-03-06</p>
                                        </th>
                                        <th>Thứ 3
                                            <p class="t-label pt-1 fz-075rem fw-400">2017-03-06</p>
                                        </th>
                                ...
                                <tbody>
                                    <tr data-id-customer="1" type="edit_production" class="click_doubble get_modal">
                                        <td class="t-center">
                                            <span data-tag="a" type="info_production" class="get_modal t-center t-green-main  t-right t-left">MÁY MÀNG 1 <i class="fas fa-edit"></i></span>
                                        </td>
                                        <td class="bg-pink">NGÀY</td>
                                        <td>TRẮNG XANH</td>
                                        <td>TRẮNG XANH</td>
                                        <td>65ML +115 ML</td>
                                        <td></td>
                                    ...
                                    <tr data-id-customer="2" type="edit_production" class="click_doubble get_modal">
                                        <td class="t-center">
                                            <span data-tag="a" type="info_production" class="get_modal t-center t-green-main  t-right t-left">MÁY MÀNG 1 <i class="fas fa-edit"></i></span>
                                        </td>
                                        <td class="bg-pink">NGÀY</td>
                        ...
                        <div class="py-2" style="border-bottom: 1px dashed #C4C4C4">
                            ...
                            <div class="form-edit-row ">
                                ...
                                <div class="amount" style="height: 2.2rem;">
                                    <button class="minus" style="width: 2.1rem;"><img src="public/images/minus.png" alt=""></button>
                                    <input type="text" value="1" class="form-input">
                                    <button class="plus" style="width: 2.1rem;"><img src="public/images/plus.png" alt=""></button>
                                </div>
                            </div>
