                ...
                <div class="wp-content p-5">
                    <div class="box-content m-0">
                        ...
                        <div class="rcontent" id="my_announce">
                            ...
                            <style>
                                .rcontent#my_announce .box-right .box-item .icon {
                                    height: 2rem;
                                }
                            </style>
                            <div class="box-right w-100" id="list_announce">
                                <!-- <div class="box-item d-flex mg-b-1rem px-3 py-5 w-100">
                                    <div class="icon mg-r-15rem"><img src="public/images/icon-invoice.png" alt=""></div>
                                    <div>
...
<script src="{{ asset('public_customer/customer_js/my-announce.js')}}" type="text/javascript "></script>
