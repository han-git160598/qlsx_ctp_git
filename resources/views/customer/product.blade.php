...
@section('content_introduce')
    <div id="wrapper" class="product">
        <div class="wp-container">
            <div class="top-content" style="min-height: auto;">
            ...
            <div class="bot-content">
                <div class="wp-content">
                    <div class="box-content">
                        ...
                        <div class="box-right d-flex flex-wrap justify-content-space-between">
    ...
    <div class="show-thumb-nail modal">
        <div class="modal-box w-40">
            <span class="close"><img src="{{ asset('public_customer/images/x.png')}}" alt=""></span>
            <img src="{{ asset('public_customer/images/product_1.png')}}" alt="">
        </div>
    </div>
    <footer>')}}
...
$(document).ready(function(){
    let output = `
        ...
        <li class="item active"><a href="{{URL::to('product')}}">Sản phẩm</a></li>
